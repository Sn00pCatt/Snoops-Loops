package loops.sn00p.api.forge.command;

import loops.sn00p.api.command.CommandFactory;
import loops.sn00p.api.command.annotate.*;
import loops.sn00p.api.command.annotate.executor.*;
import loops.sn00p.api.command.annotate.*;
import loops.sn00p.api.command.annotate.executor.*;
import loops.sn00p.api.command.exception.CommandLoadException;
import loops.sn00p.api.command.injector.ArgumentInjector;
import loops.sn00p.api.command.injector.TabCompleter;
import loops.sn00p.api.forge.command.command.ForgeCommand;
import loops.sn00p.api.forge.command.command.ForgeSenderType;
import loops.sn00p.api.forge.command.command.executor.CommandExecutor;
import loops.sn00p.api.forge.command.completion.FillerTabCompleter;
import loops.sn00p.api.forge.command.completion.number.IntegerTabCompleter;
import loops.sn00p.api.forge.command.completion.player.PlayerTabCompleter;
import loops.sn00p.api.forge.command.injector.ForgeFunctionInjector;
