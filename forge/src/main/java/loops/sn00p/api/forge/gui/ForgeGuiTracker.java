...
import loops.sn00p.api.forge.listener.LazyListener;
...
public class ForgeGuiTracker {
    ...
    public static void addGui(SnoopPlayer<?> player, ForgeGui gui) {
        if (player == null) {
            return;
        }
    ...
    public static void removePlayer(SnoopPlayer<?> player) {
        if (player == null) {
            return;
        }
    ...
    public static void enqueueUpdate(SnoopPlayer<?> player) {
        if (player == null) {
            return;
        }
