package loops.sn00p.api.forge.command.command;

import loops.sn00p.api.concurrency.UtilConcurrency;
import loops.sn00p.api.forge.command.ForgeCommandFactory;
...
public class ForgeCommand extends CommandBase {
    ...
    private List<ITextComponent> initializeDescription(String[] description) {
        ...
        if (!this.child) {
            ...
            TextComponentString textComponent = new TextComponentString("§eFor further support dm SnoopCatt");
