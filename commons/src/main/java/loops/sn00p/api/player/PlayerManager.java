 ...
 */
public interface PlayerManager<A extends SnoopPlayer<B>, B> {

     /**
      *
      * Get the {@link SnoopPlayer} implementation from the platform's player implementation
      *
     ...
     /**
      *
      * Get the {@link SnoopPlayer} implementation from the minecraft player's UUID
      *
      * Will return null if the player is not online
      *
     ...
     /**
      *
      * Gets the {@link SnoopPlayer} implementation from the player's username (if they are online)
      *
      * Will return null if the player is not online
      *
     ...
     /**
      *
      * Gets the {@link SnoopPlayer} implementation from the player's username (if they are online) (case insensitive)
      *
      * Will return null if the player is not online
      *
      * @param username The username of the minecraft player
     ...
     /**
      *
      * Gets a {@link List} of all online players in the {@link SnoopPlayer} form
      *
      *
     ...
     /**
      *
      * Registers an {@link PlayerAttribute ) class so that when the player object is
